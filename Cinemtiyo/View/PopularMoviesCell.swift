...
class PopularMoviesCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        movieTitle.textColor = UIColor(light: #colorLiteral(red: 0.7795123458, green: 0.4400732517, blue: 0.7914783955, alpha: 1), dark: #colorLiteral(red: 0.7795123458, green: 0.4400732517, blue: 0.7914783955, alpha: 1))
